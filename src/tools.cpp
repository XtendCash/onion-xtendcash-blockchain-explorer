...
/**
* Parse xtend address in a string form into
...
/**
* Return string representation of xtend address
*/
string
...
{
    // default path to xtend folder
    // on linux this is /home/<username>/.xtend
    string default_xtend_dir = tools::get_default_data_dir();

    if (nettype == cryptonote::network_type::TESTNET)
        default_xtend_dir += "/testnet";
    if (nettype == cryptonote::network_type::STAGENET)
        default_xtend_dir += "/stagenet";


    // the default folder of the lmdb blockchain database
    // is therefore as follows
    return default_xtend_dir + string("/lmdb");
}
